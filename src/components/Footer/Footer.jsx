    ...
    <footer className="bg-primary mt-[2rem]">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex justify-center text-teal-600">
          <Link to='/'>
            <img className='h-16' src={LogoPeek} alt="Logo" />
          </Link>
        </div>
        ...
        <ul className="mt-8 flex justify-center gap-4">
          <li>
            <Link
              to="https://www.facebook.com/obrgroupmex/
           "
              rel="noreferrer"
              target="_blank"
          ...
          <li>
            <Link
              to="https://www.instagram.com/obr._group/"
              rel="noreferrer"
              target="_blank"
              className="text-gray-200 transition hover:text-gray-700/75"
            >
          ...
          <li>
            <Link
              to="https://mx.linkedin.com/company/obr-group-bienes-ra%C3%ADces"
              rel="noreferrer"
              target="_blank"
              className="text-gray-200 transition hover:text-gray-700/75"
            >
